                                ...
                                <div class="block-content" style="padding: 10px 0 20px 0;">
                                    <div class="row">
                                        <div class="col-md-10 offset-md-1" id="size-half">
                                            ...
                                            <small class="form-text text-muted">Slika se sprema bez automatskog cropa i bez prisilnog resize-a.</small>
                                        </div>
                                        <div class="col-md-10 offset-md-1 ag-hide" id="size-all">
                                            ...
                                            <small class="form-text text-muted">Preporuka za desktop banner je široki omjer, ali slika se sprema bez automatskog cropa i bez prisilnog resize-a.</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
