<style>
    .withdrawal-page {
        --withdrawal-primary: #f27923;
        --withdrawal-primary-dark: #d85f0a;
    ...
    .withdrawal-page .form-control:focus {
        border-color: rgba(242, 121, 35, .65);
        box-shadow: 0 0 0 .2rem rgba(242, 121, 35, .11);
    }
    ...
    .withdrawal-submit {
        ...
        font-size: .92rem;
        font-weight: 800;
        box-shadow: 0 .55rem 1.15rem rgba(242, 121, 35, .2);
    ...
    .withdrawal-submit:focus {
        ...
        color: #fff;
        box-shadow: 0 .7rem 1.35rem rgba(242, 121, 35, .26);
    ...
    .withdrawal-review-statement {
        padding: 1.25rem;
        border: 1px solid rgba(242, 121, 35, .23);
        border-radius: .8rem;
        background: #fff6ee;
        color: var(--withdrawal-ink);
        font-size: 1rem;
