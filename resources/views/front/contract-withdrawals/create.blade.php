...
@section('title', 'Obrazac za jednostrani raskid ugovora | PNEU-MAX')
@section('description', 'Elektronički obrazac za jednostrani raskid ugovora sklopljenog na daljinu u PNEU-MAX webshopu.')
            ...
            <div class="withdrawal-card">
                <div class="withdrawal-card__body">
                    <div class="withdrawal-scope-note">
                        ...
                        neusklađenog proizvoda pošaljite upit putem
                        <a href="{{ route('kontakt') }}">kontakt obrasca</a>.
                    </div>
