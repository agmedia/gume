@php
    ...
    $cookieMessage = 'PNEU-MAX koristi kolačiće kako bi stranica radila ispravno, pretraga bila brža, a ponuda korisnija.';
    ...
    $cookieMarketingDescription = 'Pomaže nam prikazati relevantnije proizvode, ponude i oglase na PNEU-MAX stranicama i drugim kanalima.';
    $cookieLocale = app()->getLocale();
    $cookieDescription = $cookieMessage.' <a href="'.url('info/privatnost-i-kolacici').'">Privatnost i kolačići</a>';
@endphp
