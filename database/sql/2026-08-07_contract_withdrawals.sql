-- PNEU-MAX: elektronički obrazac za jednostrani raskid ugovora
-- MySQL/MariaDB ekvivalent migracije 2026_08_07_073000_create_contract_withdrawals_table.php
--
-- Skripta je idempotentna: može se sigurno pokrenuti više puta.
-- Ne briše postojeće zahtjeve i ne prepisuje postavke spremljene u adminu.
...
SELECT
    ...
    'contract_withdrawal',
    JSON_OBJECT(
        'admin_email', 'tomislav@agmedia.hr',
